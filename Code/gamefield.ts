var button3: HTMLButtonElement = document.querySelector(".button3");

var gameboardHard: HTMLDivElement = document.querySelector(".gameboardHard");
var raster3: HTMLDivElement = document.querySelector(".raster3");

var computerM: boolean = true;
var firstImgElemM: HTMLImageElement;
var secondImgElemM: HTMLImageElement;
var imgElemsM: HTMLImageElement[] = [];

//Deklaration der Variablen damit die entsprechenden div/HTML-Elemente aus dem DOM gewählt werden
var computerPointsM: HTMLDivElement = document.querySelector(".computerPoints");
var playerPointsM: HTMLDivElement = document.querySelector(".playerpoints");

//Variablendeklaration der Punkte des Computers und des Nutzers, diese werden zunächst auf 0 gesetzt
var cPointsM: number = 0;
var pPointsM: number = 0;
var firstcardM: images;
var secondcardM: images;
...
var allImagesH: images[] = [
    {
        img: "imagesH/a.png",
        name: "A", //Vergleich ob Karten gleich sind
...
button3.addEventListener("click", function (): void {
...
function playerChoiceH(): void {
    ...
    else addEventListener("click", onClickH);
}
...
function shuffleImagesH(array: images[]): images[] { 
    var temporaryValue: images;
...
eine Karte wählt*/
function openImagesH(card: images): void {
    /*hier wird abgefragt
    ...
    if (firstImgElemM == null) {
        ...
        for (var j: number = 0; j < cardsM.length; j++) {
...
function onClickH(event: MouseEvent): void {
    ...
    var b: HTMLElement = <HTMLElement>event.target;
    //ImgageElement ist in imgPick
    //als HTML img Element damit man direkt darauf zugreifen kann
    var imgPick: HTMLImageElement = <HTMLImageElement>b;
